...
def assign(values, s, d, count=0):
    ...
    counter_nodes += 1                           # Compteur pour calculer le nombre des noeuds explorés par l'algo
...
################ Search ################
# Cette fonction a été modifié pour afficher les résultats du depth-first search

def solve(grid):
    global counter,counter_nodes
